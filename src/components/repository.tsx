            ...
            <Box sx={{ display: 'flex', gap: ['24px', '24px', '24px'], py: 3, alignItems: "center" }}>
                <Box sx={{ flexGrow: 1 }}>
                    ...
                    <div className={repoStyles.tagsWrapper}>
                        ...
                        {repository.language &&
                            <Text sx={{ color: '#646d76', fontSize: "0.75em", fontWeight: 400, lineHeight: "1.5", display: 'inline-block', pl: 1, pr: 3 }}>
                                {repository.language}
                            </Text>
                        }
                        {repository.license &&
                            <Text sx={{ color: '#646d76', fontSize: "0.75em", fontWeight: 400, lineHeight: "1.5", display: 'inline-block', pr: 3 }}>
                                <LawIcon size={16} /> {repository.license}
                            </Text>
                        }
                        <Text sx={{ color: '#646d76', fontSize: "0.75em", fontWeight: 400, lineHeight: "1.5", display: 'inline-block' }}>
