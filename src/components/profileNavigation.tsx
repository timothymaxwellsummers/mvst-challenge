...
export default function Navigation({repos}: {repos: number | undefined}) {
    return (
        <>
            <UnderlineNav aria-label="Repository" sx={{ bg: '#f6f8fa' }}>
                <UnderlineNav.Item icon={BookIcon}>Overview</UnderlineNav.Item>
                <UnderlineNav.Item aria-current="page" counter={repos} icon={RepoIcon}>Repositories</UnderlineNav.Item>
